...
**Follow-on (backlog):** Insert Scripture search (PR #40) and header `/` Matching Verses | Matching Passages tabs (PR #41) are done. Future discovery lanes can join the search tab strip. See `BACKLOG.md`.
